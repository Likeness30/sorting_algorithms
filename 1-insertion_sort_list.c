...
/**
 * swap_nodes - This swaps 2 nodes in a listint_t doubly-linked list
 * @h: The head pointer to doubly-linked list
 ...
 * @list: The pointer to the head of the doubly-linked list of integers
